...
import katajaLang.compiler.lexer.Token.TokenType;
...
public final class Lexer {
    ...
    private static final class TokenBuilder{
        ...
        Token build(){
            Token token = new Token(type, valueBuilder.toString());
            valueBuilder = new StringBuilder();
            type = null;
            return token;
        }
    ...
    private void err(String message) throws LexingException{
        throw new LexingException(message, filepath, lineOffset+line, index);
    }
}
